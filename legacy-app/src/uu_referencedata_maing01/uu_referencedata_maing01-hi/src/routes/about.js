...
import Config from "src/routes/config/config.js";
import AboutCfg from "src/config/about.js";
import RouteBar from "src/core/route-bar.js";
import importLsi from "src/lsi/import-lsi.js";
//@@viewOff:imports
        ...
        <div className={Css.content()}>
          ...
          {sessionState === "authenticated" ? (
            <DynamicLibraryComponent
              ...
              productCode="support/uuReferencedata"
          ...
          <div className={Css.common()}>
            <div>{`uuReferencedata ${Environment.appVersion}`}</div>
            {license.termsOfUse && (
              <div>
