...
const Errors = require("legacy-app/src/uu_referencedata_maing01/uu_referencedata_maing01-server/app/api/errors/referencedata-main-error.js");
...
const logger = LoggerFactory.get("ReferencedataMainAbl");

class ReferencedataMainAbl {
  constructor() {
  ...
  async init(uri, dtoIn, session) {
    ...
    if (dtoIn.uuBtLocationUri) {
      ...
      const createAwscDtoIn = {
        name: "UuReferencedata",
        typeCode: "uu-referencedata-maing01",
        location: location,
...
module.exports = new ReferencedataMainAbl();
