...
import { Currency, Globe, TrendingUp } from 'lucide-react';
                    ...
                    <div className='mb-8'>
                        ...
                        <div className='grid grid-cols-1 md:grid-cols-4 gap-4 mb-6'>
                            ...
                            <StatCard
                                ...
                                title='Newest Currency'
                                textSize='xl'
                                value={
                                    // @ts-expect-error QueryLoader is not typed correctly
                                    <QueryLoader query={currencies}>
                                        {data => (data.data?.itemList || [])[0]?.name}
                                    </QueryLoader>
                                }
                            />
