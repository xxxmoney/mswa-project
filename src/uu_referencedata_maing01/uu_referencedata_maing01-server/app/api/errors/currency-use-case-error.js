...
"use strict";
const ReferencedataMainError = require("./referencedata-main-error.js"); // Base error for this subApp

const ERROR_PREFIX = ReferencedataMainError.ERROR_PREFIX + "currency/"; // Specific prefix for currency errors
...
const Create = {
  ...
  CurrencyAlreadyExists: class extends ReferencedataMainError {
    constructor(dtoOut, paramMap = {}, cause = null) {
  ...
  CurrencyDaoCreateFailed: class extends ReferencedataMainError {
    constructor(dtoOut, paramMap = {}, cause = null) {
...
const Get = {
  ...
  CurrencyNotFound: class extends ReferencedataMainError {
    constructor(dtoOut, paramMap = {}, cause = null) {
...
const Update = {
  ...
  CurrencyNotFoundToUpdate: class extends ReferencedataMainError { // Specific for update scenario
    constructor(dtoOut, paramMap = {}, cause = null) {
      super({ ...dtoOut, status: 404 }, paramMap, cause);
  ...
  CurrencyDaoUpdateFailed: class extends ReferencedataMainError {
    constructor(dtoOut, paramMap = {}, cause = null) {
      super({ ...dtoOut, status: 500 }, paramMap, cause);
...
const Archive = {
  ...
  CurrencyNotFoundToArchive: class extends ReferencedataMainError {
    constructor(dtoOut, paramMap = {}, cause = null) {
      super({ ...dtoOut, status: 404 }, paramMap, cause);
...
const ListCurrent = {
  ...
  InvalidDtoIn: class extends ReferencedataMainError { // For pageInfo validation
    constructor(dtoOut, paramMap = {}, cause = null) {
      super({ ...dtoOut, status: 400 }, paramMap, cause);
